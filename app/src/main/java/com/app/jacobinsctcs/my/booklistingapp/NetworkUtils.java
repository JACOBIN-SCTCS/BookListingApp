...
public class NetworkUtils
{
    ...
    public static String GET_JSON_RESPONSE(URL url)
    {
        ...
        try
        {
            ...
            if(response_code==200)
            {
                ...
                json_response=DECODE_STREAM(stream);
    ...
    private static String DECODE_STREAM(InputStream stream) throws IOException
    {
        StringBuilder builder=new StringBuilder();
        InputStreamReader readerl=new InputStreamReader(stream);
        BufferedReader reader=new BufferedReader(readerl);
